...
export class BrandsService {
    ...
    public getPaginated(
        ...
        return this.http
            .get<Brands[]>(`${this.url}s/paginado`, { params })
            .pipe(
                map((res) => {
                    return <Brands[]>res
                }),
    ...
    public getAll() {
        return this.http.get<Brands[]>(`${this.url}s`, this.httpOptions).pipe(
            map((res) => {
                return <Brands[]>res
            }),
            catchError(this.he.handleError)
    ...
    public update(brand: Brands): Observable<Brands> {
        return this.http
            .put<Brands>(`${this.url}/${brand.id}`, brand, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Brands>res
                }),
    ...
    public post(brand: Brands): Observable<Brands> {
        return this.http
            .post<Brands>(`${this.url}s`, brand, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Brands>res
                }),
    ...
    public delete(id: number): Observable<Brands> {
        return this.http
            .delete<Brands>(`${this.url}/${id}`, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Brands>res
                }),
