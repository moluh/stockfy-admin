...
export class CategoriesService {
    ...
    public getPaginated(
        ...
        return this.http
            .get<Categories[]>(`${this.url}s/paginado`, { params })
            .pipe(
                map((res) => {
    ...
    public getAll() {
        return this.http
            .get<Categories[]>(`${this.url}s`, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Categories[]>res
                }),
    ...
    public post(category: Categories): Observable<Categories> {
        return this.http
            .post<Categories>(`${this.url}s`, category, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Categories>res
                }),
    ...
    public delete(id: number): Observable<Categories> {
        return this.http
            .delete<Categories>(`${this.url}/${id}`, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Categories>res
                }),
