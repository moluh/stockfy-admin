...
export class ExpensesService {
  ...
  public getPaginated(pageNro: number, pageSize: number): Observable<Expenses[]> {
    let params = new HttpParams()
      .set('pageSize', pageSize.toString())
      .set('pageNro', pageNro.toString())
    return this.http.get<Expenses[]>(`${this.url}s/paginado`, { params })
      .pipe(
        map(res => { return <Expenses[]>res }),
  ...
  public getPaginatedByTxtAndFilter(
    ...
    return this.http.get<Expenses[]>(`${this.url}s/paginado/filter`, { params })
      .pipe(
        map(res => { return <Expenses[]>res }),
        catchError(this.he.handleError)
      );
  ...
  //  ====================================================================================
  public getAll() {
    return this.http.get<Expenses[]>(`${this.url}s`, this.httpOptions)
      .pipe(
        map(res => { return <Expenses[]>res }),
        catchError(this.he.handleError)
      );
  ...
  public update(exp: Expenses): Observable<Expenses> {
    return this.http.put<Expenses>(`${this.url}/${exp.id}`, exp, this.httpOptions)
      .pipe(
        map(res => { return <Expenses>res }),
        catchError(this.he.handleError)
      );
  ...
  public post(exp: Expenses): Observable<Expenses> {
    delete exp.id
    return this.http.post<Expenses>(`${this.url}s`, exp, this.httpOptions)
      .pipe(
        map(res => { return <Expenses>res }),
        catchError(this.he.handleError)
      );
  ...
  public delete(id: number): Observable<Expenses> {
    return this.http.delete<Expenses>(`${this.url}/${id}`, this.httpOptions)
      .pipe(
        map(res => { return <Expenses>res; }),
        catchError(this.he.handleError)
      );
