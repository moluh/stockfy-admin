...
export class MovementsService {
    ...
    public getPaginated(
        ...
        return this.http
            .get<Movements[]>(`${this.url}s/paginado`, { params })
            .pipe(
                map((res) => {
    ...
    public getPaginatedByStateAndClientId(
        ...
        return this.http
            .get<Movements[]>(
                `${this.url}s/paginado/clienteId/${clientId}/state/${state}`,
                {
                    params,
                }
            )
    ...
    public getPaginatedBetweenDates(
        ...
        return this.http
            .get<Movements[]>(
                `${this.url}s/paginado/desde/${from}/hasta/${to}`,
                {
                    params,
                }
            )
    ...
    public getAll() {
        return this.http
            .get<Movements[]>(`${this.url}s`, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Movements[]>res
                }),
