...
export class ProductsService {
  ...
  public getPaginated(
    ...
    return this.http.get<Products[]>(`${this.url}s/paginado`, { params }).pipe(
      map((res) => {
        return <Products[]>res;
      }),
  ...
  public getPaginatedAndFilter(
    ...
    const params = new HttpParams()
      ...
      .set('attr', attr)
      .set('text', text);
    return this.http.get<Products[]>(`${this.url}s/paginado/filter`, { params }).pipe(
      map((res) => {
        return <Products[]>res;
      }),
      catchError(this.he.handleError)
  ...
  public update(product: Products): Observable<Products> {
    return this.http
      .put<Products>(`${this.url}/${product.id}`, product, this.httpOptions)
      .pipe(
        map((res) => {
          return <Products>res;
        }),
