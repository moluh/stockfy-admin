...
export class ProvidersService {
    ...
    public getPaginated(
        ...
        return this.http
            .get<Providers[]>(`${this.url}es/paginado`, { params })
            .pipe(
    ...
    public getAll() {
        return this.http
            .get<Providers[]>(`${this.url}es`, this.httpOptions)
            .pipe(
                map((res) => {
    ...
    public post(provider: Providers): Observable<Providers> {
        return this.http
            .post<Providers>(`${this.url}es`, provider, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Providers>res
                }),
    ...
    public delete(id: number): Observable<Providers> {
        return this.http
            .delete<Providers>(`${this.url}/${id}`, this.httpOptions)
            .pipe(
                map((res) => {
                    return <Providers>res
                }),
