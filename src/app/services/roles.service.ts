...
export class RolesService {
  ...
  public getPaginated(pageNro: number, pageRole: number): Observable<Role[]> {
    ...
    return this.http.get<Role[]>(`${this.url}s/paginado`, { params })
      .pipe(
        map(res => { return <Role[]>res }),
        catchError(this.he.handleError)
      )
  }

  public getAll() {
    return this.http.get<Role[]>(`${this.url}s`, this.httpOptions)
      .pipe(
        map(res => { return <Role[]>res }),
        catchError(this.he.handleError)
      );
  ...
  public update(brand: Role): Observable<Role> {
    return this.http.put<Role>(`${this.url}/${brand.id}`, brand, this.httpOptions)
      .pipe(
        map(res => { return <Role>res }),
        catchError(this.he.handleError)
      );
  ...
  public post(brand: Role): Observable<Role> {
    return this.http.post<Role>(`${this.url}s`, brand, this.httpOptions)
      .pipe(
        map(res => { return <Role>res }),
        catchError(this.he.handleError)
      );
  ...
  public delete(id: number): Observable<Role> {
    return this.http.delete<Role>(`${this.url}/${id}`, this.httpOptions)
      .pipe(
        map(res => { return <Role>res; }),
        catchError(this.he.handleError)
      );
